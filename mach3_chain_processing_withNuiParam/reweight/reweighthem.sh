...
#file_loc=/home/mojia/scratch/jointfit/SKT2KJointFit_Data/nui_osc
file_loc=/home/mojia/scratch/jointfit/JointFit/12162024/nui_osc
#file_loc=/home/mojia/scratch/jointfit/postBANFFFit/nui_osc
...
root_files=$(find ${file_loc} -name "*_float_osc_nui.root" -type f)
echo "Root files:"
...
#save_dir=/home/mojia/scratch/jointfit/SKT2KJointFit_Data/nui_osc_RCreweighted
#save_dir=/home/mojia/scratch/jointfit/postBANFFFit/nui_osc_RCreweighted
save_dir=/home/mojia/scratch/jointfit/JointFit/12162024/nui_osc_RCreweighted
mkdir -pv $save_dir
