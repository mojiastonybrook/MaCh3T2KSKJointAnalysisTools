...
#file_loc=/home/mojia/scratch/jointfit/SKonly/02042024
#file_loc=/project/6008045/skt2kjoint/DataChains_Summit/raw
#file_loc=/project/6008045/skt2kjoint/PostBANFF_Fits/20240814_BANFF_01
file_loc=/home/mojia/scratch/jointfit/JointFit/12162024/JF_CorrEs_batch_1
...
#root_files=$(find ${file_loc} -name "*_chain_*_Iter_0_7.root" -type f)
root_files=$(find ${file_loc} -name "MaCh3_Job_*_Iter_*_Exec_*.root" -type f)
...
#save_dir=/home/mojia/scratch/jointfit/postBANFFFit/nui_osc
save_dir=/home/mojia/scratch/jointfit/JointFit/12162024/nui_osc
mkdir -pv $save_dir
...
for file in $files; do
  ...
  output=${output%%.root}_float_osc_nui.root
  ...
  ScriptFileName="./reduceRawDataSet_wrapper.sh $file $output"
