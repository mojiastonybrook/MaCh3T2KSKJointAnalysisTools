...
#files=/home/mojia/scratch/jointfit/JointFit_extra/JF_OscProbCalModified_Merge_float_reduced_reweighted.root
files=/home/mojia/scratch/jointfit/JointFit_detShiSme/beluga/JF_ShiNSme_Merge_float_reduced_reweighted.root

RCs="false true"
burnin=80000
#addinfo="JFex_OscProbCalMod"
addinfo="detSyst_ShiftNSmear"
...
for file in $files; do
  ...
  for RC in $RCs; do
    ...
    #wait
    root -l -b -q 'MakeContours1D.C("'$file'", '$burnin', '$RC', 0, false,"'$addinfo'")' &
    wait
